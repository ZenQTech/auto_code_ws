...
# v6.36.0 Cycle 59 G59-FIX：VibeCoding 后端 API（补全 G58-01 后端缺失）
from .vibe_coding import router as vibe_coding_router
api_router.include_router(vibe_coding_router, tags=["VibeCoding"])
